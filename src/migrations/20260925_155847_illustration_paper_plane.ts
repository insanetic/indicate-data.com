...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."enum_pages_blocks_hero_visual_illustration" ADD VALUE IF NOT EXISTS 'paperPlane';
  ALTER TYPE "public"."enum_pages_blocks_media_visual_illustration" ADD VALUE IF NOT EXISTS 'paperPlane';
  ALTER TYPE "public"."enum_pages_blocks_split_visual_illustration" ADD VALUE IF NOT EXISTS 'paperPlane';
  ALTER TYPE "public"."enum_pages_blocks_feature_tabs_tabs_visual_illustration" ADD VALUE IF NOT EXISTS 'paperPlane';
  ALTER TYPE "public"."enum_pages_blocks_feature_story_visual_illustration" ADD VALUE IF NOT EXISTS 'paperPlane';
  ALTER TYPE "public"."enum_pages_blocks_integrations_visual_illustration" ADD VALUE IF NOT EXISTS 'paperPlane';
  ALTER TYPE "public"."enum__pages_v_blocks_hero_visual_illustration" ADD VALUE IF NOT EXISTS 'paperPlane';
  ALTER TYPE "public"."enum__pages_v_blocks_media_visual_illustration" ADD VALUE IF NOT EXISTS 'paperPlane';
  ALTER TYPE "public"."enum__pages_v_blocks_split_visual_illustration" ADD VALUE IF NOT EXISTS 'paperPlane';
  ALTER TYPE "public"."enum__pages_v_blocks_feature_tabs_tabs_visual_illustration" ADD VALUE IF NOT EXISTS 'paperPlane';
  ALTER TYPE "public"."enum__pages_v_blocks_feature_story_visual_illustration" ADD VALUE IF NOT EXISTS 'paperPlane';
  ALTER TYPE "public"."enum__pages_v_blocks_integrations_visual_illustration" ADD VALUE IF NOT EXISTS 'paperPlane';`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_hero_visual_illustration" AS ENUM('stage', 'resiHub', 'dashboard', 'agent', 'comparison', 'sources', 'team', 'integrations', 'alerts', 'builder', 'flyingKpis', 'portfolio', 'campaigns', 'agentChat', 'resi', 'mcp', 'kpiStudio', 'templates', 'governance', 'sync', 'semanticLayer', 'dimensions', 'collections');
  ...
  CREATE TYPE "public"."enum_pages_blocks_media_visual_illustration" AS ENUM('stage', 'resiHub', 'dashboard', 'agent', 'comparison', 'sources', 'team', 'integrations', 'alerts', 'builder', 'flyingKpis', 'portfolio', 'campaigns', 'agentChat', 'resi', 'mcp', 'kpiStudio', 'templates', 'governance', 'sync', 'semanticLayer', 'dimensions', 'collections');
  ...
  CREATE TYPE "public"."enum_pages_blocks_split_visual_illustration" AS ENUM('stage', 'resiHub', 'dashboard', 'agent', 'comparison', 'sources', 'team', 'integrations', 'alerts', 'builder', 'flyingKpis', 'portfolio', 'campaigns', 'agentChat', 'resi', 'mcp', 'kpiStudio', 'templates', 'governance', 'sync', 'semanticLayer', 'dimensions', 'collections');
  ...
  CREATE TYPE "public"."enum_pages_blocks_feature_tabs_tabs_visual_illustration" AS ENUM('stage', 'resiHub', 'dashboard', 'agent', 'comparison', 'sources', 'team', 'integrations', 'alerts', 'builder', 'flyingKpis', 'portfolio', 'campaigns', 'agentChat', 'resi', 'mcp', 'kpiStudio', 'templates', 'governance', 'sync', 'semanticLayer', 'dimensions', 'collections');
  ...
  CREATE TYPE "public"."enum_pages_blocks_feature_story_visual_illustration" AS ENUM('stage', 'resiHub', 'dashboard', 'agent', 'comparison', 'sources', 'team', 'integrations', 'alerts', 'builder', 'flyingKpis', 'portfolio', 'campaigns', 'agentChat', 'resi', 'mcp', 'kpiStudio', 'templates', 'governance', 'sync', 'semanticLayer', 'dimensions', 'collections');
  ...
  CREATE TYPE "public"."enum_pages_blocks_integrations_visual_illustration" AS ENUM('stage', 'resiHub', 'dashboard', 'agent', 'comparison', 'sources', 'team', 'integrations', 'alerts', 'builder', 'flyingKpis', 'portfolio', 'campaigns', 'agentChat', 'resi', 'mcp', 'kpiStudio', 'templates', 'governance', 'sync', 'semanticLayer', 'dimensions', 'collections');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_hero_visual_illustration" AS ENUM('stage', 'resiHub', 'dashboard', 'agent', 'comparison', 'sources', 'team', 'integrations', 'alerts', 'builder', 'flyingKpis', 'portfolio', 'campaigns', 'agentChat', 'resi', 'mcp', 'kpiStudio', 'templates', 'governance', 'sync', 'semanticLayer', 'dimensions', 'collections');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_media_visual_illustration" AS ENUM('stage', 'resiHub', 'dashboard', 'agent', 'comparison', 'sources', 'team', 'integrations', 'alerts', 'builder', 'flyingKpis', 'portfolio', 'campaigns', 'agentChat', 'resi', 'mcp', 'kpiStudio', 'templates', 'governance', 'sync', 'semanticLayer', 'dimensions', 'collections');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_split_visual_illustration" AS ENUM('stage', 'resiHub', 'dashboard', 'agent', 'comparison', 'sources', 'team', 'integrations', 'alerts', 'builder', 'flyingKpis', 'portfolio', 'campaigns', 'agentChat', 'resi', 'mcp', 'kpiStudio', 'templates', 'governance', 'sync', 'semanticLayer', 'dimensions', 'collections');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_feature_tabs_tabs_visual_illustration" AS ENUM('stage', 'resiHub', 'dashboard', 'agent', 'comparison', 'sources', 'team', 'integrations', 'alerts', 'builder', 'flyingKpis', 'portfolio', 'campaigns', 'agentChat', 'resi', 'mcp', 'kpiStudio', 'templates', 'governance', 'sync', 'semanticLayer', 'dimensions', 'collections');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_feature_story_visual_illustration" AS ENUM('stage', 'resiHub', 'dashboard', 'agent', 'comparison', 'sources', 'team', 'integrations', 'alerts', 'builder', 'flyingKpis', 'portfolio', 'campaigns', 'agentChat', 'resi', 'mcp', 'kpiStudio', 'templates', 'governance', 'sync', 'semanticLayer', 'dimensions', 'collections');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_integrations_visual_illustration" AS ENUM('stage', 'resiHub', 'dashboard', 'agent', 'comparison', 'sources', 'team', 'integrations', 'alerts', 'builder', 'flyingKpis', 'portfolio', 'campaigns', 'agentChat', 'resi', 'mcp', 'kpiStudio', 'templates', 'governance', 'sync', 'semanticLayer', 'dimensions', 'collections');
