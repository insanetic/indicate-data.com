...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TYPE "public"."enum_pages_blocks_hero_visual_illustration" ADD VALUE 'resiHub' BEFORE 'dashboard';
  ALTER TYPE "public"."enum_pages_blocks_media_visual_illustration" ADD VALUE 'resiHub' BEFORE 'dashboard';
  ALTER TYPE "public"."enum_pages_blocks_split_visual_illustration" ADD VALUE 'resiHub' BEFORE 'dashboard';
  ALTER TYPE "public"."enum_pages_blocks_feature_tabs_tabs_visual_illustration" ADD VALUE 'resiHub' BEFORE 'dashboard';
  ALTER TYPE "public"."enum_pages_blocks_feature_story_visual_illustration" ADD VALUE 'resiHub' BEFORE 'dashboard';
  ALTER TYPE "public"."enum_pages_blocks_integrations_visual_illustration" ADD VALUE 'resiHub' BEFORE 'dashboard';
  ALTER TYPE "public"."enum__pages_v_blocks_hero_visual_illustration" ADD VALUE 'resiHub' BEFORE 'dashboard';
  ALTER TYPE "public"."enum__pages_v_blocks_media_visual_illustration" ADD VALUE 'resiHub' BEFORE 'dashboard';
  ALTER TYPE "public"."enum__pages_v_blocks_split_visual_illustration" ADD VALUE 'resiHub' BEFORE 'dashboard';
  ALTER TYPE "public"."enum__pages_v_blocks_feature_tabs_tabs_visual_illustration" ADD VALUE 'resiHub' BEFORE 'dashboard';
  ALTER TYPE "public"."enum__pages_v_blocks_feature_story_visual_illustration" ADD VALUE 'resiHub' BEFORE 'dashboard';
  ALTER TYPE "public"."enum__pages_v_blocks_integrations_visual_illustration" ADD VALUE 'resiHub' BEFORE 'dashboard';
