 ...
 * `getMediaUrl` keeps it relative, so Next.js treats it as a local image and optimizes it via
 * `/_next/image?url=...&w=1200&q=75` without `remotePatterns` or a custom `loader`.
 *
