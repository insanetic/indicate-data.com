...
/**
 * Flattens a CMS sidebar into plain groups the client component can render. Groups whose
 * links all fail to resolve are dropped, so an empty sidebar renders nothing at all.
 */
